...
export const products: BullionProduct[] = [
  ...
  },
  {
    ...
    stock: 9,
    availability: "Low Stock",
    image: "/images/products/iconic-bullion-20g.webp",
    gallery: ["/images/products/iconic-bullion-20g.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
    id: "iconic-1oz",
    brand: "Iconic Bullion",
    name: "1oz / 31.1g Minted Gold Bar",
    weightGrams: 31.1,
    ...
    stock: 7,
    availability: "Low Stock",
    image: "/images/products/iconic-bullion-1oz.webp",
    gallery: ["/images/products/iconic-bullion-1oz.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
    ...
    stock: 6,
    availability: "Low Stock",
    image: "/images/products/iconic-bullion-50g.webp",
    gallery: ["/images/products/iconic-bullion-50g.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
    ...
    stock: 5,
    availability: "In Stock",
    image: "/images/products/iconic-bullion-100g.webp",
    gallery: ["/images/products/iconic-bullion-100g.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
    ...
    stock: 3,
    availability: "Low Stock",
    image: "/images/products/iconic-bullion-250g.webp",
    gallery: ["/images/products/iconic-bullion-250g.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
    ...
    stock: 2,
    availability: "Low Stock",
    image: "/images/products/iconic-bullion-500g.webp",
    gallery: ["/images/products/iconic-bullion-500g.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
    ...
    stock: 1,
    availability: "Low Stock",
    image: "/images/products/iconic-bullion-1kg.webp",
    gallery: ["/images/products/iconic-bullion-1kg.webp"],
    iconicSerialEligible: true,
    featured: true
  },
  {
